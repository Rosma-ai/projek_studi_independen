              ...
              <div class="col-lg-12">
                <div class="p-5">
                  ...
                  <form method="post" action="proses_register.php" class="user">
                    ...
                    <div class="form-group">
                      <input name="telp" type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Masukan Nomor Telepon Anda..." required>
                    </div>
